        ...
        <div>
            ...
            <div className="flex flex-col gap-5">
                ...
                <div className="flex justify-start items-center gap-3">
                    <RiUser6Line size={20} />
                    <p className="text-sm font-light w-full flex justify-between items-center m-0">
                        Upgrade to plus
                ...
                <Link href={'#'} className="flex justify-start gap-3">
                    ...
                    <p className="text-sm font-light m-0">Judgements</p>
                </Link>
                
                {/* Acts and Laws Button */}
                <Link href={'#'} className="flex justify-start gap-3">
                    <RiScales3Line size={20} />
                    <p className="text-sm font-light m-0">Acts and Laws</p>
                </Link>
                ...
                <form action={signoutAction}>
                    <button type="submit" className="flex justify-start gap-3">
                        ...
                        <p className="text-sm font-light m-0">Sign out</p>
                    </button>
                </form>
            </div>
        </div>
