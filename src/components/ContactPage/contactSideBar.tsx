...
const ContactSideBar = () =>{
    ...
    <div className="flex bg-primary-color rounded-lg shadow-md">
        <div className="flex flex-col px-5 pt-4 pb-4 max-w-max">
            ...
            <div className="flex justify-end"><Button onClick={() => blogsRoute.push("/blogs")} className="text-lg bg-blue-400 hover:opacity-75 hover:text-white">More blogs ⏎</Button>
            </div>
        </div>
    </div>
